document.addEventListener('alpine:init', () => {
  Alpine.data('shop', () => ({
    ...
    categories: [
      ...
      { id: 'vong_co_gian', name: 'Vòng co giãn', image: './assets/images/product_img/co gian/vong_tron_co_gian.jpg' },
      { id: 'mix_day_ngu_sac', name: 'Mix dây ngũ sắc', image: './assets/images/product_img/vong-ngu-sac/ngu-sac-mix-1-hat-dau.jpg' },
      { id: 'mix_hat_bo_de', name: 'Mix hạt bồ đề', image: './assets/images/product_img/bo de/vong_dau_tam_sole_9_hat_bo_de.jpg' },
